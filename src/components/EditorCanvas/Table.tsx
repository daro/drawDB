    ...
    <>
      ...
      >
        ...
        >
          ...
          />
          <div
            className={`overflow-hidden font-bold h-[50px] flex justify-between items-center border-b border-gray-400 ${
  ...
  function renderField(fieldData: IField, index: number) {
    ...
    return (
      <div
        ...
        onPointerEnter={(e) => {
          if (!e.isPrimary || !settings.showFieldSummary || linking) return;
