    ...
    <>
      <div className="py-4 px-12 sm:px-4 flex justify-between items-center">
        <div className="flex items-center justify-between w-full">
          ...
          <div className={`md:hidden flex gap-12 ${isDark ? "text-zinc-100" : ""}`}>
            <Link
              className="text-lg font-semibold hover:text-sky-400 transition-colors duration-300"
              onClick={() =>
                document
          ...
          <div className={`md:hidden block space-x-3 ms-12 ${isDark ? "text-zinc-100" : ""}`}>
            <a
        ...
        <button
          ...
          className={`hidden md:inline-block h-[24px] ${isDark ? "text-zinc-100" : ""}`}
        >
