...
const pl = {
  translation: {
    ...
    auto_split_relationships: "Automatyczne dzielenie relacji",
    rename_fk: "Zmień nazwę klucza obcego",
    show_relationship_labels: "Pokaż etykiety relacji",
    one_side_label: "(1) Etykieta strony jeden",
    many_side_label_n: "(N) Etykieta strony wiele",
    ...
    add_type: "Dodaj typ",
    assign_supertype: "Przypisz supertyp",
    click_table_to_assign_supertype: "Kliknij na tabelę, aby przypisać ją jako supertyp",
    tables_must_have_relationship_to_assign_supertype: "Tabele muszą mieć relację, aby przypisać supertyp",
    subtype_cannot_be_supertype: "Podtyp nie może być supertypem",
    to_do: "Do zrobienia",
    tables: "Tabele",
    ...
    one_side: "strona jeden",
    many_side: "strona wiele",
    one_side_label_default: "1",
    many_side_label_default: "n",
    many_side_label: "Etykieta strony wiele(n)",
    relationship_name_font_size: "Rozmiar czcionki nazwy relacji",
    relationship_side_label_font_size: "Rozmiar czcionki etykiet stron relacji",
    show_relationship_names: "Pokaż nazwy relacji",
    move_label: "Przesuń etykietę",
    start_x: "Start X",
    start_y: "Start Y",
    end_x: "End X",
    end_y: "End Y",
    rotate: "Obróć",
    label_offset_x: "Przesunięcie etykiety X",
    label_offset_y: "Przesunięcie etykiety Y",
    label_ratio: "Pozycja etykiety (ratio)",
    strict_mode_info: "Wymuszaj rygorystyczne zasady nazewnictwa tabel i pól",
    show_grid_info: "Przełącz widoczność siatki na kanwie",
    snap_to_grid_info: "Automatycznie wyrównuj obiekty do najbliższej linii siatki",
    show_datatype_info: "Pokaż lub ukryj typy danych pól na diagramie",
    show_cardinality_info: "Wyświetlaj oznaczenia krotności relacji (np. 1:n)",
    show_pk_icons_info: "Przełącz widoczność ikony klucza głównego (PK) przy polach",
    show_fk_icons_info: "Przełącz widoczność ikony klucza obcego (FK) przy polach",
    field_details_info: "Pokaż dodatkowe informacje o polach w widoku podsumowania",
    table_names_uppercase_info: "Wymuszaj wyświetlanie wszystkich nazw tabel wielkimi literami",
    show_relationship_labels_info: "Przełącz widoczność etykiet bocznych relacji",
    show_relationship_names_info: "Przełącz widoczność nazw relacji na kanwie",
    rename_fk_info: "Automatycznie zmieniaj nazwy pól kluczy obcych przy tworzeniu relacji",
    spread_relations_info: "Lepiej rozkładaj linie relacji, aby zapobiec ich nakładaniu się",
    side_margin_info: "Ustaw margines poziomy dla trasowania relacji",
  },
};
